...
// This class defines a work station
public class WorkStation implements Resource{
	...
	public WorkStation(String resourceId){
		this.setResourceId(resourceId);
		System.out.println("Inside Workstation constructor. Work Station Created");
	}
	...
	// Method to display resource details
		public void showResourceDetails(){
			...
			System.out.println("Resource type: Work station");
