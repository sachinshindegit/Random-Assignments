...
// Defines a vintage table setting
public class Vintage implements ITableSetting{
	...
	public Vintage() {
		System.out.println("Inside Vintage Constructor creating a vintage table setting");
		createTableSetting();
	}
