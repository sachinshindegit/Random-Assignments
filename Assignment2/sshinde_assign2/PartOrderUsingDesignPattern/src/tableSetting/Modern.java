...
// Defines a modern table setting
public class Modern implements ITableSetting{
	...
	public Modern() {
		System.out.println("Inside Modern Constructor creating a Modern table setting");
		createTableSetting();
	}
